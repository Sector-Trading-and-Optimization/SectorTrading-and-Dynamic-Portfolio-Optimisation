...
Original file is located at
    https://colab.research.google.com/drive/1uznCmLetX_gv_2SoNOmP1Z2Jh6pXJVJ9
...
class Backtester:
    ...
    def print_summary(self, strategy_name="Strategy", risk_info=None):
        """
        Print a compact executive summary, optionally including risk level.
        Pass `risk_info` as the dict returned by your RiskManager.assess().
        """
        m = self.metrics()
...
def main():
    # Data imports
    from stock_selector import prices_all, signals_all, weights_dict
